...
class sinatra_Route {
	...
	static function match($route, $path) {
		$pattern = (Std::is($route, _hx_qtype("EReg")) ? eval("if(isset(\$this)) \$»this =& \$this;\$tmp = \$route;
			\$»r = (Std::is(\$tmp, _hx_qtype(\"EReg\")) ? \$tmp : eval(\"if(isset(\\\$this)) \\\$»this =& \\\$this;throw new HException(\\\"Class cast error\\\");
				return \\\$»r2;
			\"));
			return \$»r;
